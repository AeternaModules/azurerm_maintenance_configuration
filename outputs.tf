output "maintenance_configurations" {
  ...
  value       = azurerm_maintenance_configuration.maintenance_configurations
}
output "maintenance_configurations_in_guest_user_patch_mode" {
  ...
  value       = [for k, v in azurerm_maintenance_configuration.maintenance_configurations : v.in_guest_user_patch_mode]
}
output "maintenance_configurations_install_patches" {
  ...
  value       = [for k, v in azurerm_maintenance_configuration.maintenance_configurations : v.install_patches]
}
output "maintenance_configurations_location" {
  description = "List of location values across all maintenance_configurations"
  value       = [for k, v in azurerm_maintenance_configuration.maintenance_configurations : v.location]
}
output "maintenance_configurations_name" {
  description = "List of name values across all maintenance_configurations"
  value       = [for k, v in azurerm_maintenance_configuration.maintenance_configurations : v.name]
}
output "maintenance_configurations_properties" {
  description = "List of properties values across all maintenance_configurations"
  value       = [for k, v in azurerm_maintenance_configuration.maintenance_configurations : v.properties]
}
